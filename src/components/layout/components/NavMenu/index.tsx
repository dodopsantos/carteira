  ...
  return (
    <div ref={menuRef}>
      <button
        ...
        type="button"
        className="items-center p-2 ml-3 text-sm text-gray-500 rounded lg:hidden bg-sky-200 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        aria-controls="navbar-default"
        aria-expanded="false"
      >
        <span className="sr-only">Open main menu</span>
        <svg
          className="w-6 h-6 fill-sky-900"
          aria-hidden="true"
          fill="currentColor"
          viewBox="0 0 20 20"
      ...
      {open && (
        <div
          className="absolute z-50 top-16 left-5 right-5 rounded bg-sky-700 lg:block lg:w-auto"
          id="navbar-default"
        >
